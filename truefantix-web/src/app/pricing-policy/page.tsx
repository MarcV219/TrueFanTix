    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col">
      ...
      <section className="bg-[var(--tft-navy)] text-white py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Pricing and Fee Policy</h1>
          <p className="text-xl text-gray-300">Transparent pricing with no hidden charges</p>
        </div>
      </section>

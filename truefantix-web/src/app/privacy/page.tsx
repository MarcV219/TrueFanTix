    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col">
      ...
      <section className="bg-[#064a93] py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ color: "#e6edf5" }}>Privacy Policy</h1>
          <p className="text-xl" style={{ color: "#e6edf5" }}>Your privacy matters to us</p>
        </div>
      </section>

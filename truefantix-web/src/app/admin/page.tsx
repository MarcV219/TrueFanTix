          ...
          <section style={{ display: "grid", gridTemplateColumns: "minmax(280px, 0.9fr) minmax(320px, 1.1fr)", gap: 18 }}>
            <Card title="Queues">
              <div style={{ display: "grid", gap: 8 }}>
                ...
                <QueueItem label="Seller/Stripe attention" value={data.queues.pendingSellerStripe} href="/admin/users" />
                <QueueItem label="Expired reservations" value={data.queues.expiredReservations} href="/admin/orders?status=PENDING" />
                <QueueItem label="Open escrows" value={data.queues.openEscrows} href="/admin/orders" />
                <QueueItem label="Failed payments" value={data.queues.failedPayments} href="/admin/orders" />
                <QueueItem label="Pending payouts" value={data.queues.pendingPayouts} href="/admin/users" />

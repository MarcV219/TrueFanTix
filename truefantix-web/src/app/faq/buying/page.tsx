    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col">
      ...
      <section className="bg-[#064a93] py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ color: "#e6edf5" }}>Buying Tickets</h1>
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed mt-4">
              TrueFanTix is not currently collecting tax on the admin fee. All fees are shown clearly at checkout.
            </p>
          </div>

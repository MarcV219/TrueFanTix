...
export type AuditAction =
  ...
  | "ADMIN_OUTREACH_CONNECT"
  | "ADMIN_OUTREACH_DISCONNECT"
  | "ADMIN_OUTREACH_CAMPAIGN_CREATE"
  | "ADMIN_OUTREACH_CAMPAIGN_UPDATE"
  | "ADMIN_OUTREACH_CAMPAIGN_DELETE"
  | "ADMIN_OUTREACH_RECIPIENT_EDIT"
  | "ADMIN_OUTREACH_TEMPLATE_DELETE"
  | "ADMIN_OUTREACH_SEND"
  | "ADMIN_OUTREACH_SUPPRESS"

...
function city(name: string, region: string, country = "USA", aliases?: string[]): CitySeed {
  return { name, region, country, aliases };
}
...
const EXPANDED_NORTH_AMERICA_CITIES: CitySeed[] = [
  ...
  city("Lethbridge", "AB", "Canada"),
  city("London", "ON", "Canada"),
  city("Longueuil", "QC", "Canada"),
  city("Markham", "ON", "Canada"),
  city("Medicine Hat", "AB", "Canada"),
  city("Milton", "ON", "Canada"),
  city("Mississauga", "ON", "Canada"),
  city("Moncton", "NB", "Canada"),
  city("Montreal", "QC", "Canada"),
  city("Moose Jaw", "SK", "Canada"),
  city("Nanaimo", "BC", "Canada"),
  city("New Westminster", "BC", "Canada"),
  city("Newmarket", "ON", "Canada"),
  city("Niagara Falls", "ON", "Canada"),
  city("North Bay", "ON", "Canada"),
  city("Oakville", "ON", "Canada"),
  city("Oshawa", "ON", "Canada"),
  city("Ottawa", "ON", "Canada"),
  city("Peterborough", "ON", "Canada"),
  city("Penticton", "BC", "Canada"),
  city("Pickering", "ON", "Canada"),
  city("Prince Albert", "SK", "Canada"),
  city("Prince George", "BC", "Canada"),
  city("Quebec City", "QC", "Canada", ["Quebec", "Quebec City"]),
  city("Red Deer", "AB", "Canada"),
  city("Regina", "SK", "Canada"),
  city("Richmond", "BC", "Canada"),
  city("Richmond Hill", "ON", "Canada"),
  city("Saanich", "BC", "Canada"),
  city("Saguenay", "QC", "Canada"),
  city("Saint John", "NB", "Canada"),
  city("Sarnia", "ON", "Canada"),
  city("Saskatoon", "SK", "Canada"),
  city("Sault Ste. Marie", "ON", "Canada", ["Soo"]),
  city("Sherbrooke", "QC", "Canada"),
  city("St. Catharines", "ON", "Canada"),
  city("St. John's", "NL", "Canada"),
  city("Surrey", "BC", "Canada"),
  city("Thunder Bay", "ON", "Canada"),
  city("Toronto", "ON", "Canada", ["GTA", "Greater Toronto Area"]),
  city("Trois-Rivieres", "QC", "Canada", ["Trois-Rivieres"]),
  city("Vancouver", "BC", "Canada"),
  city("Vaughan", "ON", "Canada"),
  city("Victoria", "BC", "Canada"),
  city("Waterloo", "ON", "Canada"),
  city("Whitby", "ON", "Canada"),
  city("Windsor", "ON", "Canada"),
  city("Winnipeg", "MB", "Canada"),

  // United States: large cities, capitals, sports markets, and common touring stops.
  city("Albuquerque", "NM"),
  city("Anaheim", "CA"),
  city("Anchorage", "AK"),
  city("Arlington", "TX"),
  ...
  city("Kansas City", "KS"),
  city("Knoxville", "TN"),
  city("Las Vegas", "NV", "USA", ["Vegas"]),
  city("Lexington", "KY"),
  city("Lincoln", "NE"),
  city("Little Rock", "AR"),
  city("Long Beach", "CA"),
  city("Los Angeles", "CA", "USA", ["LA", "L.A."]),
  city("Louisville", "KY"),
  city("Madison", "WI"),
  city("Memphis", "TN"),
  city("Miami", "FL"),
  ...
  city("Nashville", "TN"),
  city("New Orleans", "LA"),
  city("New York", "NY", "USA", ["NYC", "New York City", "Manhattan"]),
  city("Newark", "NJ"),
  city("Norfolk", "VA"),
  city("Oakland", "CA"),
  city("Oklahoma City", "OK", "USA", ["OKC"]),
  city("Omaha", "NE"),
  city("Orlando", "FL"),
  city("Palm Desert", "CA"),
  city("Philadelphia", "PA", "USA", ["Philly"]),
  city("Phoenix", "AZ"),
  city("Pittsburgh", "PA"),
  city("Portland", "OR"),
  city("Providence", "RI"),
  ...
  city("San Antonio", "TX"),
  city("San Diego", "CA"),
  city("San Francisco", "CA", "USA", ["SF"]),
  city("San Jose", "CA"),
  city("Santa Clara", "CA"),
  city("Scottsdale", "AZ"),
  city("Seattle", "WA"),
  city("Spokane", "WA"),
  city("St. Louis", "MO", "USA", ["Saint Louis"]),
  city("St. Paul", "MN", "USA", ["Saint Paul"]),
  city("Syracuse", "NY"),
  city("Tacoma", "WA"),
  city("Tallahassee", "FL"),
  city("Tampa", "FL"),
  ...
  city("Washington", "DC", "USA", ["Washington DC", "D.C.", "DC"]),
  city("West Palm Beach", "FL"),
  city("Wichita", "KS"),

  // Mexico: major metros and touring/sports markets.
  city("Cancun", "ROO", "Mexico"),
  city("Guadalajara", "JAL", "Mexico"),
  city("Leon", "GUA", "Mexico"),
  city("Mexico City", "CMX", "Mexico", ["CDMX", "Ciudad de Mexico"]),
  city("Monterrey", "NLE", "Mexico"),
  city("Puebla", "PUE", "Mexico"),
  city("Queretaro", "QUE", "Mexico"),
  city("Tijuana", "BCN", "Mexico"),
  city("Toluca", "MEX", "Mexico"),
];

const ALL_CITIES = Array.from(
  [
    ...CITIES,
    ...EXPANDED_NORTH_AMERICA_CITIES,
    ...ALL_TEAMS.map((item) => city(item.city, item.region, item.country)),
    ...VENUES.map((item) => city(item.city, item.region, item.country)),
  ].reduce((byKey, item) => {
    const key = `${item.country}:${item.region}:${item.name}`.toLowerCase();
    if (!byKey.has(key)) byKey.set(key, item);
    return byKey;
  }, new Map<string, CitySeed>()).values()
);
